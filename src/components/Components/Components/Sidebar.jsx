                    ...
                    <div className=' p-4 rounded-lg'>
                        <div className='flex flex-col gap-1'>
                            {menuOptions.map((option) => (
                                <NavLink key={option.label} to={option.path} className={({ isActive }) => `flex items-center gap-2 ${isActive ? 'bg-blue-500/10' : ''} p-2 rounded-lg`}>
                        ...
                        <div className='mt-4 space-y-4'>
                            <h2 className='text-xl font-semibold border-t border-gray-200 pt-4'>My Groups</h2>
                            {myGroups.map((group) => (
